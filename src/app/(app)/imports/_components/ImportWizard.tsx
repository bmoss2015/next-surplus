  ...
  return (
    <div className="mx-auto w-full max-w-[900px] overflow-hidden rounded-md border border-gray-200">
      {missingRequiredKeys.length > 0 && (
        <div className="flex items-center gap-1.5 border-b border-[#0d4b3a] bg-[#e0f2f7] px-3 py-2 text-[12px] text-[#04261c]">
          ...
          return (
            <div
              ...
              className={cn(
                ...
                needsMapping && "border-l-2 border-l-[#0d4b3a] bg-[#f0f9ff]"
              )}
            >
              ...
              <div className="flex min-w-0 items-center gap-1.5">
                ...
                {isMapped ? (
                  ...
                  <span className="inline-flex shrink-0 items-center rounded-full bg-[#e0f2f7] px-1.5 py-[2px] text-[9px] font-medium text-[#04261c]">
                    Needs Mapping
                  </span>
                )}
              </div>
    ...
    <div className="flex flex-wrap items-center gap-1.5 text-[10.5px] font-medium">
      ...
      <span
        className={cn(
          ...
          unrecCount > 0 ? "bg-[#e0f2f7] text-[#04261c]" : "bg-gray-100 text-gray-500"
        )}
      >
  ...
  if (step === "map") {
    ...
    return (
      <Shell step={step}>
        ...
        {unrecognizedCols.length > 0 && (
          <div className="mx-auto mt-4 flex max-w-[900px] flex-wrap items-center justify-between gap-2 rounded-md border border-[#0d4b3a] bg-[#e0f2f7] px-3 py-2 text-[11.5px] font-medium text-[#04261c]">
            <span>
            ...
            <button
              ...
              className="inline-flex cursor-pointer items-center gap-1 rounded-md border border-[#0d4b3a] bg-surface px-2.5 py-1 text-xs font-medium text-[#04261c] hover:bg-[#f0f9ff]"
            >
