...
const PETROL_COLORS = ["#0f1729", "#0d4b3a", "#13644e", "#4a9c75", "#dc2626"];
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <style jsx global>{`
        ...
        .ProseMirror h1 { font-size: 20px; font-weight: 600; margin: 12px 0 8px; color: #0d4b3a; }
        .ProseMirror h2 { font-size: 16px; font-weight: 600; margin: 10px 0 6px; color: #0d4b3a; }
        .ProseMirror p { margin: 0 0 8px; }
        .ProseMirror ul, .ProseMirror ol { padding-left: 1.5em; margin: 0 0 8px; }
        .ProseMirror a { color: #13644e; text-decoration: underline; }
      `}</style>
