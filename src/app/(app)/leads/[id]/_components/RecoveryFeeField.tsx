  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <div className="group flex items-center gap-1.5">
        {editing ? (
          <span className="inline-flex items-center rounded-md bg-gradient-to-br from-[#04261c] to-[#0d4b3a] py-[4px] pl-[14px] pr-[11px] text-[14px] font-semibold text-white ring-2 ring-[#0d4b3a]/45">
            <input
              type="text"
              inputMode="decimal"
              autoFocus
          ...
          <button
            ...
            className="inline-flex cursor-text items-center rounded-md bg-gradient-to-br from-[#04261c] to-[#0d4b3a] px-[14px] py-[4px] text-[14px] font-semibold text-white transition-colors hover:from-[#0d4b3a] hover:to-[#13644e]"
          >
            {saved}%
          </button>
        )}
