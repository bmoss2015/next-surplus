    ...
    >
      ...
      <div className="mt-6 flex items-center gap-5">
        ...
        <div className="text-right">
          ...
          <div className="mt-1 text-[40px] font-semibold tabular-nums tracking-[-0.025em] leading-none text-white">
            02:14
          </div>
        </div>
      </div>
      ...
      <div className="mt-7 flex items-center gap-2">
        ...
        <CallControl label="Add Note" />
        <button className="ml-auto rounded-full bg-danger px-5 py-2.5 text-[13px] font-medium text-white shadow-[0_8px_22px_-8px_rgba(185,28,28,0.55)] hover:brightness-110">
          End Call
        </button>
      </div>
    </article>
...
function CallControl({ label }: { label: string }) {
  return (
    <button className="rounded-full border border-white/15 bg-white/[0.08] px-3.5 py-2 text-[12px] text-white backdrop-blur hover:bg-white/15">
      {label}
    </button>
  );
}
