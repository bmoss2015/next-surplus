...
export default function V44TimelineOpenPage() {
  return (
    <FullFrame label="V44 · Activity Timeline Open" tabs={TABS} active="timeline">
      <V44 lead={HAYES} queue={QUEUE_DEFAULT} overlay="timeline" />
    </FullFrame>
  );
}
