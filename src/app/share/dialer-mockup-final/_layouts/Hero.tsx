...
export function Hero({
  ...
  return (
    <div
      className={`relative flex h-full min-h-0 flex-col overflow-hidden text-white ${PETROL_GRADIENT}`}
    >
      {wrap && nextLead && (
        <CountdownBanner
      ...
      <div className="flex min-h-0 flex-1 flex-col px-8 pt-5 pb-6">
        <div className="flex items-center justify-between gap-4">
          <CaseTypeChip index={lead.contactIndex} total={lead.contactTotal} />
        ...
        <div className="mt-5 flex items-start justify-between gap-8">
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-2 whitespace-nowrap font-mono text-[15px] tracking-wide text-white/90 tabular-nums">
              {lead.phone}
            </div>
        ...
        <div className="mt-auto">
          ...
          {wrap ? (
            <div>
              ...
              <div className="mt-3">
                <OutcomeRow selected={selectedOutcome} />
              </div>
              <QuickNoteInput />
              <SkipFollowUpToggle />
            </div>
