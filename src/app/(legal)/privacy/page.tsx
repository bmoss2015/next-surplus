  ...
  return (
    <article className="prose-legal">
      ...
      <Section title="1. Information We Collect">
        ...
        <Sub title="1.3 Bank Account Information (Via Plaid)">
          <p>
            If you connect a bank account for check sending, we use Plaid,
            Inc. to verify your bank account. Plaid collects your bank login
            credentials directly through its secure interface. We receive and
            store (encrypted at rest) a Plaid access token and account
            identifier. We use Plaid&apos;s verified routing and account
            numbers solely to create a verified bank account with our mail
            provider for check disbursement. We do not access your bank
            transaction history, balances, or other financial data beyond
            what is required for account verification. See Plaid&apos;s
            privacy policy at{" "}
        ...
        <Sub title="1.6 Usage Data and Analytics">
          <p>
        ...
        <Sub title="1.7 Error Monitoring">
          <p>
      ...
      <Section title="2. How We Use Your Information">
        ...
        <ul>
          ...
          <li>
            Process your subscription payments and metered billing for
            physical mail
          </li>
          <li>
          ...
          <li>
            Send physical mail (letters and checks) on your behalf through our
            mail provider
          </li>
          ...
          <table className="w-full border-collapse text-[14px]">
            ...
            <tbody>
              ...
              <ProviderRow
                ...
                purpose="Subscription billing, metered billing"
                data="Email, name, payment method (handled by Stripe directly)"
              />
              <ProviderRow
                provider="Plaid (bank verification)"
                purpose="Bank account verification"
                data="Bank login credentials (handled by Plaid directly), access token"
              />
              <ProviderRow
                provider="Mail delivery provider"
                purpose="Sending letters and checks"
                data="Recipient names, mailing addresses, letter and check content, bank account details for checks"
              />
              <ProviderRow
      ...
      <Section title="4. Data Storage and Security">
        ...
        <ul>
          ...
          <li>
            Plaid access tokens are encrypted at rest using application level
            encryption
          </li>
      ...
      <Section title="5. Data Retention">
        <ul>
          <li>
            ...
            subscription and for 30 days after account cancellation, after
            which it is deleted.
          </li>
          <li>
            <strong>Lead Data:</strong> Retained for the duration of your
            subscription. Upon account deletion, all Lead Data is permanently
            deleted within 30 days.
          </li>
          <li>
            <strong>Gmail data:</strong> Cached email data is deleted when you
            disconnect your Gmail account or when your account is deleted.
          </li>
          <li>
      ...
      <Section title="6. Your Rights">
        <Sub title="6.1 All Users">
          ...
          <ul>
            ...
            <li>
              <strong>Delete</strong> your account and personal data by
              requesting account deletion (see Section 7)
            </li>
            <li>
            ...
            <li>
              <strong>Disconnect</strong> your bank account at any time
              through Settings
            </li>
          </ul>
        </Sub>
      ...
      <Section title="7. Account Deletion">
        ...
        <ul>
          <li>
            Your account, organization, and all associated Lead Data will be
            permanently deleted within 30 days
          </li>
          <li>
            Your Gmail connection will be revoked and cached email data
            deleted
          </li>
          <li>Your Plaid bank connection will be revoked</li>
          <li>Your Stripe subscription will be cancelled</li>
          <li>
            Anonymized analytics data and billing records required for legal
            compliance may be retained
          </li>
        </ul>
      </Section>

      <Section title="8. Multi Tenant Architecture">
        <p>
