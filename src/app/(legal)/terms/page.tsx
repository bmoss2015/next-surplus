    ...
    <article className="prose-legal">
      ...
      <Section title="1. The Service">
        <p>
          ...
          tracking, email integration, document management, and related
          tools.
        </p>
        <p>
      ...
      <Section title="3. Subscription and Billing">
        ...
        <Sub title="3.2 Payment Processing">
          <p>
            ...
            your payment method on file for the monthly subscription fee.
          </p>
        </Sub>
        <Sub title="3.3 Failed Payments">
          <p>
            ...
            actions (editing leads, importing data). To restore full access,
            update your payment method through the Stripe Customer Portal.
          </p>
        </Sub>
        <Sub title="3.4 Cancellation">
          <p>
            You may cancel your subscription at any time through the Stripe
            Customer Portal accessible from Settings &gt; Billing in the
            Service. Upon cancellation, your subscription remains active
            until the end of the current billing period. You may export your
            data at any time before or after cancellation using the export
            features within the Service.
          </p>
          <p>We do not offer prorated refunds for partial months.</p>
        </Sub>
        <Sub title="3.5 Price Changes">
          <p>
      ...
      <Section title="5. Acceptable Use">
        ...
        <ul>
          ...
          <li>
            Use the Service to send unsolicited bulk email or spam through
            the email features
          </li>
          <li>
      ...
      <Section title="6. Email Integration">
        <p>
          We support email integration with Gmail. Microsoft Outlook and IMAP
          support are coming. Email integration is included in your
          subscription at no extra cost.
        </p>
        <Sub title="6.1 Account Connection">
          <p>
            Connecting an email account is optional. When you connect, you
            authorize us to access that account through the provider&apos;s
            OAuth or IMAP authentication system with the permissions
            described in our Privacy Policy.
          </p>
        </Sub>
        <Sub title="6.2 Your Responsibility">
          <p>
            Emails you send through the Service are sent from your connected
        ...
        <Sub title="6.3 Disconnecting">
          <p>
            You may disconnect a connected email account at any time through
      ...
      <Section title="10. Indemnification">
        ...
        <ul>
          ...
          <li>The content of email you send through the Service</li>
          <li>
      ...
      <Section title="13. Termination">
        ...
        <Sub title="13.3 Effect of Termination">
          <p>
            ...
            immediately (or at end of billing period for cancellations). You
            remain able to export your data through the export features
            within the Service.
          </p>
        </Sub>
      </Section>
