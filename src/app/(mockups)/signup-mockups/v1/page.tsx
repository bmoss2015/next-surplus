...
export default function SignupV1Linear() {
  return (
    <div className="flex min-h-[calc(100vh-49px)] items-center justify-center bg-white px-6 py-16">
      <div className="w-full max-w-[360px]">
        ...
        <form className="flex flex-col gap-3.5">
          <Field label="Firm Name" placeholder="" />
          <Field label="Work Email" type="email" placeholder="" />
          <PasswordField tone="linear" />
          <button
            type="submit"
  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <input
        ...
        className="h-[32px] w-full rounded-[6px] border border-[#e5e7eb] bg-white px-3 text-[13px] text-[#04261c] outline-none placeholder:text-[#9ca3af] focus:border-[#13644e]"
      />
    </div>
  );
}
