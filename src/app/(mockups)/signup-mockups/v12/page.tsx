...
const FEATURES = [
  "Lead pipeline with custom stages and automation",
  "Threaded inbox across Gmail, Outlook, and IMAP",
  "Physical mail and verified checks from your inbox",
  "Team seats, audit trail, and shared playbooks",
];

export default function SignupV12Stripe() {
  return (
  ...
  return (
    ...
    >
      ...
      <div className="text-white">
        <h2 className="m-0 text-[44px] font-semibold leading-[1.06] tracking-[-0.025em]">
          Pipeline, inbox, mail.{" "}
          <span className="text-white/55">One workspace.</span>
        </h2>
        <p className="mt-5 max-w-[560px] text-[14.5px] leading-relaxed text-white/70">
          Stop juggling spreadsheets, sticky notes, and a five tab
          browser. Next Surplus is the operations platform built for
...
function FoundersRatePill() {
  return (
    <div className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/[0.06] px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.14em] text-white/85">
...
function FoundersRateStrip() {
  return (
    <div className="grid grid-cols-[auto_1fr] items-center gap-6 border-t border-white/15 pt-6">
      <div>
      ...
      <div className="text-[12.5px] leading-relaxed text-white/70">
        ...
        public window ends, standard pricing applies after.
      </div>
    </div>
  );
}
